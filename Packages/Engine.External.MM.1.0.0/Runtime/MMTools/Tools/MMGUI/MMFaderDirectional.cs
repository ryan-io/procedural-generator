...
namespace MMTools {
    ...
    public class MMFaderDirectional : MonoBehaviour, IEngineEventListener<MMFadeEvent>, IEngineEventListener<MMFadeInEvent>, IEngineEventListener<MMFadeOutEvent>, IEngineEventListener<MMFadeStopEvent>
    {
