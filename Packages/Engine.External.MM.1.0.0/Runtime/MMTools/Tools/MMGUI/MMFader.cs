...
namespace MMTools {
	...
	public class MMFader : MonoBehaviour, IEngineEventListener<MMFadeEvent>, IEngineEventListener<MMFadeInEvent>,
	                       IEngineEventListener<MMFadeOutEvent>, IEngineEventListener<MMFadeStopEvent> {
		...
		public virtual void OnEventHeard(MMFadeEvent fadeEvent) {
		...
		/// </summary>
		/// <param name="fadeEvent">Fade event.</param>
		public virtual void OnEventHeard(MMFadeInEvent fadeEvent) {
		...
		/// </summary>
		/// <param name="fadeEvent">Fade event.</param>
		public virtual void OnEventHeard(MMFadeOutEvent fadeEvent) {
		...
		/// </summary>
		/// <param name="fadeEvent">Fade event.</param>
		public virtual void OnEventHeard(MMFadeStopEvent fadeStopEvent) {
		...
		protected virtual void OnEnable() {
			this.StartListeningToEvents<MMFadeEvent>();
			this.StartListeningToEvents<MMFadeStopEvent>();
			this.StartListeningToEvents<MMFadeInEvent>();
			this.StartListeningToEvents<MMFadeOutEvent>();
		}
		...
		protected virtual void OnDisable() {
			this.StopListeningToEvents<MMFadeEvent>();
			this.StopListeningToEvents<MMFadeStopEvent>();
			this.StopListeningToEvents<MMFadeInEvent>();
			this.StopListeningToEvents<MMFadeOutEvent>();
		}
	}
}