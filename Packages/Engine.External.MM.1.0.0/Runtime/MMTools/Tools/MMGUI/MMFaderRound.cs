...
namespace MMTools {
    ...
    public class MMFaderRound : MonoBehaviour, IEngineEventListener<MMFadeEvent>, IEngineEventListener<MMFadeInEvent>, IEngineEventListener<MMFadeOutEvent>, IEngineEventListener<MMFadeStopEvent>
    {
