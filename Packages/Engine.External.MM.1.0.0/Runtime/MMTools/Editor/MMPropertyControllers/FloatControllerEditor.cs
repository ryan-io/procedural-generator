...
namespace MMTools.Editor
{
    ...
    public class FloatControllerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (myTarget.AttributeNames != null)
            {
                if (myTarget.AttributeNames.Length > 0)
                {
                    ...
                    UnityEditor.Editor.DrawPropertiesExcluding(serializedObject, new string[] { "m_Script", "TargetObject", "Curve", "MinValue", "MaxValue", "Duration", "Amplitude",
