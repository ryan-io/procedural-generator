...
namespace MMTools.Editor
{
	...
	[InitializeOnLoad]
	public class MMPathEditor : UnityEditor.Editor 
	{		
		...
		protected virtual void OnSceneGUI()
	    {
			...
			for (int i=0;i<t.PathElements.Count;i++)
			{
				...
				var fmh_48_57_638223221904766812 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint,.5f,new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
