...
namespace InventoryEngine {
	[SelectionBase]
	public class InventoryDisplay : MonoBehaviour, IEngineEventListener<MMInventoryEvent>
	{
		[Header("Binding")] [MMInformation("An InventoryDisplay is a component that will handle the visualization of the data contained in an Inventory. Start by specifying the name of the inventory you want to display.", MMInformationAttribute.InformationType.Info, false)]
