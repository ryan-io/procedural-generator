...
namespace InventoryEngine {
	...
	/// </summary>
	public class InventoryInputManager : MonoBehaviour, IEngineEventListener<MMInventoryEvent> {
		[Header("Targets")]
		[MMInformation(
		...
		public virtual void OpenInventory() {
			...
			EngineEventGame.Trigger("inventoryOpens");
		...
		public virtual void CloseInventory() {
			...
			EngineEventGame.Trigger("inventoryCloses");
			InventoryIsOpen = false;
