...
namespace InventoryEngine {
    [Serializable]
    public class Inventory : MonoBehaviour, IEngineEventListener<MMInventoryEvent>, IEngineEventListener<EngineEventGame>
    {
        ...
        [Header("Player ID")] [Tooltip("a unique ID used to identify the owner of this inventory")]
        ...
        [Header("Inventory Type")] [Tooltip("Here you can define your inventory's type. Main are 'regular' inventories. Equipment inventories will be bound to a certain item class and have dedicated options.")]
        ...
        [Header("Debug")] [Tooltip("The Inventory component is like the database and controller part of your inventory. It won't show anything on screen, you'll need also an InventoryDisplay for that. Here you can decide whether or not you want to output a debug content in the inspector (useful for debugging).")]
        ...
        public virtual void OnEventHeard(EngineEventGame gameEvent)
        {
        ...
        {
            this.StartListeningToEvents<EngineEventGame>();
            this.StartListeningToEvents<MMInventoryEvent>();
        }
        ...
        {
            this.StopListeningToEvents<EngineEventGame>();
            this.StopListeningToEvents<MMInventoryEvent>();
        }
    }
}