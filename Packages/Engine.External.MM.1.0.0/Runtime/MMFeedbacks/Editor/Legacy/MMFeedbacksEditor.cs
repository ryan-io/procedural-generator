...
namespace MMFeedbacks.Editor
{
    ...
    public class MMFeedbacksEditor : UnityEditor.Editor
    {
        /// <summary>
        ...
        protected      Dictionary<MMFeedback, UnityEditor.Editor> _editors;
        ...
        void OnEnable()
        {
            ...
            // Create editors
            _editors = new Dictionary<MMFeedback, UnityEditor.Editor>();
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (int i = 0; i < _mmfeedbacks.arraySize; i++)
            {
                ...
                if (isExpanded)
                {
                    ...
                    UnityEditor.Editor editor = _editors[feedback];
        ...
        protected virtual void AddEditor(MMFeedback feedback)
        {
            ...
            if (!_editors.ContainsKey(feedback))
            {
                ...
                _editors.Add(feedback, editor as UnityEditor.Editor);
            }
        }
